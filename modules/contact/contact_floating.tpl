...
if (myform.contact_name.value == "") { window.alert("<{$smarty.const._MD_MYTHEME_NAME_INFO}>"); myform.contact_name.focus(); return false; }

if (myform.contact_mail.value == "") { window.alert("<{$smarty.const._MD_MYTHEME_MAIL_INFO}>"); myform.contact_mail.focus(); return false; }

if (myform.contact_subject.value == "") { window.alert("<{$smarty.const._MD_MYTHEME_SUBJECT_INFO}>"); myform.contact_subject.focus(); return false; }

if (myform.contact_message.value == "") { window.alert("<{$smarty.const._MD_MYTHEME_MESSAGE_INFO}>"); myform.contact_message.focus(); return false; }
return true;
}
//--></script>
</div>
