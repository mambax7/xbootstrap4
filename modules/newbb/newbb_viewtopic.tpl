        ...
        <{if $viewer_level gt 1}>
            <div class="col-sm-8 col-md-8">
                ...
                <form name="form_posts_admin" action="action.post.php" method="POST" onsubmit="if(window.document.form_posts_admin.op.value < 1){return false;}">
                    ...
                    <input type="hidden" name="topic_id" value="<{$topic_id}>" class="form-control">
    ...
    <div class="row collapse mb10" id="forum-search">
        <div class="col-sm-12 col-md-12">
            <{if $mode lte 1}>
                ...
                <input type="hidden" name="topic" id="topic" value="<{$topic_id}>" class="form-control">
                ...
                <input type="hidden" name="show_search" id="show_search" value="post_text" class="form-control">
                <span class="input-group-btn">
                        <input type="submit" class="btn btn-primary form-control" value="<{$smarty.const._MD_NEWBB_SEARCH}>">
                    </span>
            <{/if}>
        </div>
    </div>
