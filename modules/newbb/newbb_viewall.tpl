                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="item"><a href="<{$unreplied_link}>"><{$smarty.const._MD_NEWBB_VIEW}>
...
<table class="table table-responsive" width="100%" align="center">
    ...
    <tbody>
    <!-- start forum topic -->
    <tr class="<{cycle values=" even,odd"}=""><!-- irmtfan add topic-read/topic-new smarty variable  -->
    <td width="4%" align="center" class="<{if $topic.topic_read eq 1 }>topic-read<{else}>topic-new<{/if}>">
    <{if $mode gt 1}>
<input type=" checkbox
    " name="topic_id[]" id="topic_id[<{$topic.topic_id}>]" value="<{$topic.topic_id}>">
    <{else}>
    <!-- irmtfan add lock -->
                ...
                <form method="get" action="<{$selection.action}>">
                    ...
                    <{foreach item=hidval key=hidvar from=$selection.vars}>
                        <{if $hidval && $hidvar neq "sort" && $hidvar neq "order" && $hidvar neq "since"}>
                            ...
                            <input type="hidden" name="<{$hidvar}>" value="<{$hidval}>" class="form-control">
                        <{/if}>
                    <{/foreach}>
                    <!-- irmtfan remove name="refresh" -->
                    <input type="submit" value="<{$smarty.const._SUBMIT}>" class="form-control">
                </form>
            <{/strip}>
        </td>
    </tr>
