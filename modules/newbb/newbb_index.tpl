            ...
            <div class="newbb-header-icons hidden-xs">
                ...
                <{if $viewer_level gt 1}>
                    <div class="col-md-12">
                        ...
                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/moderate.php" title="<{$smarty.const._MD_NEWBB_TYPE_SUSPEND}>" class="btn btn-xs btn-primary">
                            <{$smarty.const._MD_NEWBB_TYPE_SUSPEND}>
                        </a>

                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/admin/index.php" title="<{$smarty.const._MD_NEWBB_ADMINCP}>" class="btn btn-xs btn-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row newbb-list-foruns mb10">
                        <div class="col-sm-6 col-md-6">
                            ...
                            <!-- Forum description -->
                            <{if $forum.forum_desc != ""}>
                                <button class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-target="#forumDesc-<{$forum.forum_id}>"><span class="fa fa-info-sign"></span></button>
    ...
    <div class="row">
        <div class="col-md-8 mb10">
            <form class="input-group" action="<{$xoops_url}>/modules/<{$xoops_dirname}>/search.php" method="post" name="search" id="search" role="search">
                ...
                <input type="hidden" name="forum" id="forum" value="all" class="form-control">
