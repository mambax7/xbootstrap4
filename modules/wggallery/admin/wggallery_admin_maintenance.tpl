...
<{if isset($system_check)}>
	<table class='table table-bordered'>
		...
		<tbody>
			<{foreach item=check from=$system_check|default:null}>
    ...
    <table class='table table-bordered'>
        <thead>
            <tr class='head'>
                ...
                <{if isset($show_result)}><th class='center' style='width:35%'><{$smarty.const._AM_WGGALLERY_MAINTENANCE_RESULTS}></th><{/if}>
        ...
        <tbody>
            ...
            <{if isset($show_gt)}>
                <tr class="<{cycle values='odd, even'}>">
                    ...
                    <{if isset($show_result)}><td class='left'><{$result}></td><{/if}>
                    <td class='center '>
