...
<{if $jssor_bullets == 'bullet-033'}>
        <style>
            ...
            .jssorb033 .i .b {fill:#000;fill-opacity:0.5;stroke:#fff;stroke-width:1200;stroke-miterlimit:10;stroke-opacity:0.3;}
            .jssorb033 .i:hover .b {fill:#fff;fill-opacity:.7;stroke:#000;stroke-opacity:.5;}
            .jssorb033 .iav .b {fill:#fff;stroke:#000;fill-opacity:1;}
...
<{if $jssor_bullets == 'bullet-034'}>
        <style>
            ...
            .jssorb034 .i .b {fill:#fff;fill-opacity:0.7;stroke:#000;stroke-width:1200;stroke-miterlimit:10;stroke-opacity:0.25;}
            .jssorb034 .i:hover .b {fill:#000;fill-opacity:.6;stroke:#fff;stroke-opacity:.35;}
            .jssorb034 .iav .b {fill:#000;fill-opacity:1;stroke:#fff;stroke-opacity:.35;}
            .jssorb034 .i.idn {opacity:.3;}
        </style>
        <div data-u="navigator" class="jssorb034" style="position:absolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
            <div data-u="prototype" class="i" style="width:16px;height:16px;">
                <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                    <path class="b" d="M11400,13800H4600c-1320,0-2400-1080-2400-2400V4600c0-1320,1080-2400,2400-2400h6800 c1320,0,2400,1080,2400,2400v6800C13800,12720,12720,13800,11400,13800z"></path>
                </svg>
...
<{if $jssor_bullets == 'bullet-035'}>
        ...
        <div data-u="navigator" class="jssorb035" style="position:absolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
            <div data-u="prototype" class="i" style="width:16px;height:16px;">
                <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
...
<{if $jssor_bullets == 'bullet-036'}>
        ...
        <div data-u="navigator" class="jssorb036" style="position:absolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
            <div data-u="prototype" class="i" style="width:16px;height:16px;">
                <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                    <rect class="b" x="2200" y="2200" width="11600" height="11600"></rect>
                </svg>
...
<{if $jssor_bullets == 'bullet-056'}>
        ...
        <div data-u="navigator" class="jssorb056" style="position:absolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
            <div data-u="prototype" class="i" style="width:16px;height:16px;">
                <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                    <rect class="b" x="2200" y="2200" width="11600" height="11600"></rect>
                </svg>
...
<{if $jssor_bullets == 'bullet-058'}>
        ...
        <div data-u="navigator" class="jssorb058" style="position:absolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
            <div data-u="prototype" class="i" style="width:16px;height:16px;">
                <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                    <circle class="b" cx="8000" cy="8000" r="5000"></circle>
                </svg>
...
<{if $jssor_bullets == 'bullet-062'}>
        <style type="text/css">
            ...
            .jssorb062 .i .b {fill:#000;fill-opacity:.5;stroke:#fff;stroke-width:400;stroke-miterlimit:10;stroke-opacity:0.5;}
            .jssorb062 .i:hover .b {fill-opacity:.8;}
            .jssorb062 .iav .b {fill:#00fbff;fill-opacity:1;stroke:#00bbff;stroke-opacity:.7;stroke-width:2000;}
            .jssorb062 .iav:hover .b {fill-opacity:.6;}
            .jssorb062 .i.idn {opacity:.3;}
        </style>
...
<{if $jssor_bullets == 'bullet-063'}>
        <style type="text/css">
            ...
            .jssorb063 .i .b {fill:#fff;stroke:#000;stroke-width:400;stroke-miterlimit:10;stroke-opacity:0.5;}
            .jssorb063 .i:hover .b {fill-opacity:.7;}
            .jssorb063 .iav .b {fill:#ffe200;stroke:#ffaa00;stroke-opacity:.7;stroke-width:2000;}
