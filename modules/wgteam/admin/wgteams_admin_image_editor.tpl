	...
	<div id='imghandler' class='col-xs-12 col-sm-12'>
		...
		<div class='tab-content '>
            ...
            <div class='tab-pane active center' id='1'>
				<img id='currentImg' class='img-fluid imageeditor-img center' src='<{$imgCurrent.src}>' alt='<{$imgCurrent.img_name}>'>
			...
			<div class='tab-pane' id='2'>
                ...
                <div class='col-xs-12 col-sm-6'>
                    <h5>&nbsp;</h5>
                    <img id='ImageSelected' class='img-fluid imageeditor-img' src='<{$imgCurrent.src}>' alt='<{$imgCurrent.img_name}>'>
                </div>
			...
			<div class='tab-pane' id='3'>
				...
				<div class='col-xs-12 col-sm-4'>
					<button id='btnGridAdd1' type='button' class='btn <{$btn_style}>' style='display:inline;margin:5px' data-toggle='modal' data-target='#myModalImagePicker1'><{$smarty.const._AM_WGTEAMS_IMG_EDITOR_GRID_SRC1}></button>
					<img src='<{$wgteams_upload_image_url}>blank.gif' name='imageGrid1' id='imageGrid1' alt='imageGrid1' style='margin:5px;max-width:75px'>
					<br>
					<button id='btnGridAdd2' type='button' class='btn <{$btn_style}>' style='display:inline;margin:5px' data-toggle='modal' data-target='#myModalImagePicker2'><{$smarty.const._AM_WGTEAMS_IMG_EDITOR_GRID_SRC2}></button>
					<img src='<{$wgteams_upload_image_url}>blank.gif' name='imageGrid2' id='imageGrid2' alt='imageGrid2' style='margin:5px;max-width:75px'>
					<br>
					<button id='btnGridAdd3' type='button' class='btn <{$btn_style}>' style='display:inline;margin:5px' data-toggle='modal' data-target='#myModalImagePicker3'><{$smarty.const._AM_WGTEAMS_IMG_EDITOR_GRID_SRC3}></button>
					<img src='<{$wgteams_upload_image_url}>blank.gif' name='imageGrid3' id='imageGrid3' alt='imageGrid3' style='margin:5px;max-width:75px'>
					<br>
					<button id='btnGridAdd4' type='button' class='btn <{$btn_style}>' style='display:inline;margin:5px' data-toggle='modal' data-target='#myModalImagePicker4'><{$smarty.const._AM_WGTEAMS_IMG_EDITOR_GRID_SRC4}></button>
					<img src='<{$wgteams_upload_image_url}>blank.gif' name='imageGrid4' id='imageGrid4' alt='imageGrid4' style='margin:5px;max-width:75px'>
					<br>
					<button id='btnGridAdd5' type='button' class='btn <{$btn_style}>' style='display:inline;margin:5px' data-toggle='modal' data-target='#myModalImagePicker5' disabled='disabled'><{$smarty.const._AM_WGTEAMS_IMG_EDITOR_GRID_SRC5}></button>
					<img src='<{$wgteams_upload_image_url}>blank.gif' name='imageGrid5' id='imageGrid5' alt='imageGrid5' style='margin:5px;max-width:75px'>
					<br>
					<button id='btnGridAdd6' type='button' class='btn <{$btn_style}>' style='display:inline;margin:5px' data-toggle='modal' data-target='#myModalImagePicker6' disabled='disabled'><{$smarty.const._AM_WGTEAMS_IMG_EDITOR_GRID_SRC6}></button>
			...
			<div class='tab-pane center' id='4' >
                ...
                <div class="container-crop">
                    <div class="row">
                        <div class="img-container">
                            <img id='cropImg' class="img-fluid" src="<{$imgCurrent.src}>" alt="<{$imgCurrent.img_name}>'">
                        </div>
                    </div>
                </div>
                <div class="row" id="actions">
					<div class="col-md-12 docs-toggles">
                        ...
                        <div class="btn-group d-flex flex-nowrap" data-toggle="buttons">
                            ...
                            <label class="btn imageeditor-btn-crop <{$btn_style}>">
                                ...
                                <span class="docs-tooltip" data-toggle="tooltip" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_ASPECTRATIO}>: 1 / 1">1:1</span>
                            </label>
                            <label class="btn imageeditor-btn-crop <{$btn_style}>">
                                <input type="radio" class="sr-only" id="aspectRatio4" name="aspectRatio" value="0.6666666666666666">
                                <span class="docs-tooltip" data-toggle="tooltip" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_ASPECTRATIO}>: 2 / 3">2:3</span>
                            </label>
                            <label class="btn imageeditor-btn-crop <{$btn_style}>">
                                <input type="radio" class="sr-only" id="aspectRatio5" name="aspectRatio" value="NaN">
                                <span class="docs-tooltip" data-toggle="tooltip" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_ASPECTRATIO}>: NaN"><{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_ASPECTRATIO_FREE}></span>
                            </label>
                        </div>
                    </div><!-- /.docs-toggles -->
                    <div class="col-md-12 docs-buttons">
                        <!-- <h3>Toolbar:</h3> -->
                        <div class="btn-group">
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="setDragMode" data-option="move" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_MOVE}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.setDragMode(&quot;move&quot;)"><span class="fa fa-arrows"></span></span>
                            </button>
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="setDragMode" data-option="crop" title="Crop">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="zoom" data-option="0.1" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_ZOOMIN}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.zoom(0.1)"><span class="fa fa-search-plus"></span></span>
                            </button>
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="zoom" data-option="-0.1" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_ZOOMOUT}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.zoom(-0.1)"><span class="fa fa-search-minus"></span></span>
                            </button>
                        </div>

                        <div class="btn-group">
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="move" data-option="-10" data-second-option="0" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_MOVE_LEFT}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.move(-10, 0)"><span class="fa fa-arrow-left"></span></span>
                            </button>
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="move" data-option="10" data-second-option="0" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_MOVE_RIGHT}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.move(10, 0)"><span class="fa fa-arrow-right"></span></span>
                            </button>
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="move" data-option="0" data-second-option="-10" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_MOVE_UP}>"><span class="docs-tooltip" data-toggle="tooltip" title="cropper.move(0, -10)"><span class="fa fa-arrow-up"></span></span>
                            </button>
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="move" data-option="0" data-second-option="10" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_MOVE_DOWN}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.move(0, 10)"><span class="fa fa-arrow-down"></span></span>
                            </button>
                        </div>

                        <div class="btn-group">
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="rotate" data-option="-45" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_ROTATE_LEFT}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.rotate(-45)"><span class="fa fa-rotate-left"></span></span>
                            </button>
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="rotate" data-option="45" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_ROTATE_RIGHT}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.rotate(45)"><span class="fa fa-rotate-right"></span></span>
                            </button>
                        </div>

                        <div class="btn-group">
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="scaleX" data-option="-1" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_FLIP_HORIZONTAL}>">
                                <span class="docs-tooltip" data-toggle="tooltip" title="cropper.scaleX(-1)"><span class="fa fa-arrows-h"></span></span>
                            </button>
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="scaleY" data-option="-1" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_FLIP_VERTICAL}>">
